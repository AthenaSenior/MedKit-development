                      ...
                      child: Padding(
                        ...
                        Column(
                            children: [
                              ...
                              const Text(
                                  "MedKit application allows users to take pictures of medication using their smartphone's camera, then recognize the medication and provide information about it.",
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                      color: Colors.black,
                                      fontSize: 17)
                              ...
                              const Text(
                                  "MedKit may not be able to identify all types of medication. Some medication may not be included in the app's database, and the app may not be able to identify medications with similar appearances.",
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                      color: Colors.black,
                                      fontSize: 17)
                              ...
                              const Text(
                                  "Opposite drag warning gives a warning for medicines that should not be used together.",
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                      color: Colors.black,
                                      fontSize: 17)
                              ...
                              const Text(
                                  "The scanned medicines can be accessed from the profile tab.",
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                      color: Colors.black,
                                      fontSize: 17)
                              ...
                              const Text(
                                  "No, MedKit should not be used as a substitute for consulting a healthcare professional. It is always important to consult with a doctor or pharmacist before taking any new medication.",
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                      color: Colors.black,
                                      fontSize: 17)
